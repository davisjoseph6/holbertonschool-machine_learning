...
def inception_block(A_prev, filters):
    ...
    max_pool_conv = K.layers.Conv2D(FPP, (1, 1), padding='same', activation='relu')(max_pool)

    # Concatenate all branches
    output = K.layers.Concatenate(axis=-1)([conv_1x1, conv_3x3, conv_5x5, max_pool_conv])
