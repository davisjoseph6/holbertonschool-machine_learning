...
# Define the custom LayerScale layer
class LayerScale(K.layers.Layer):
    ...
    def call(self, inputs, **kwargs):
        # Add custom computation logic if needed
        return inputs
...
if __name__ == "__main__":
    ...
    # Save the model with custom object scope
    with K.utils.custom_object_scope({'LayerScale': LayerScale}):
