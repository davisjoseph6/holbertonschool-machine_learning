...
class Transformer(tf.keras.Model):
    ...
    def call(self, inputs, target, training, encoder_mask, look_ahead_mask, decoder_mask):
        ...
        """
        encoder_output = self.encoder(inputs, training, encoder_mask)  # Encoder output
        decoder_output = self.decoder(target, encoder_output, training, look_ahead_mask, decoder_mask)  # Decoder output
