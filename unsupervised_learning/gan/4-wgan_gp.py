#!/usr/bin/env python3
"""
WGAN_GP module with replace weights method.
"""
...
class WGAN_GP(keras.Model):
    ...
    def replace_weights(self, gen_h5, disc_h5):
        """
        Replace the weights of the generator and discriminator with the
        weights stored in the .h5 files gen_h5 and disc_h5.
        """
